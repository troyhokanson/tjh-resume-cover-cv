...
recruiter packet, and bio. Never paraphrase, estimate, or hand-roll from memory.
...
```
Title:      Detective / Electronic Crimes Unit (ECU)
Employer:   Lakeville Police Department
Location:   Lakeville, MN
...
Duration:   18 years (concurrent with sworn law enforcement service)
Notes:      Phoenix500 Faculty Excellence Award -- 2020, 2021.
            Faculty of the Year Nomination -- 2021.
            Always note "concurrent with sworn service" when both roles overlap.
...
|---|---|
| DCECTF full reference | Dakota County Electronic Crimes Task Force (DCECTF) |
...
## Adjunct Duration -- Canonical Statement

> Eighteen years as a remote adjunct Criminal Justice faculty member at the University of
> Phoenix (March 2007 - October 2025), concurrent with full-time sworn service.

Use "18 years" or "eighteen years" -- never "19 years". The correct figure is 18.

---

## Key Career Statistics (use verbatim in documents)
...
## Awards and Honors (Employment-Related)
...
Written Commendations (20+)
  Employer: Lakeville Police Department
  Years:    Various (see credentials_catalog.json for individual entries)
```
...
dates. Any date in a resume or CV that conflicts with this file is wrong -- fix the build
