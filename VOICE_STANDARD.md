...
- **Investigations-experienced specificity.** Names verified tools, actions, and evidence boundaries. Never vague ("handled cases"); use source-backed language such as "performed write-blocked acquisition and FTK/IEF analysis of a computer in a wire-fraud matter and identified responsive artifacts." Attribute broader public outcomes to their official sources instead of presenting them as Troy's personal results.
