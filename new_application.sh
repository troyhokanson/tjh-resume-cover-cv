...
echo "  3. Export the final resume and cover letter to PDF"
echo "  4. Run the mandatory paired delivery gate before sending:"
echo "     python delivery_gate.py RESUME.pdf COVER_LETTER.pdf --profile $PROFILE"
echo "     Add --icac only for accurately documented ICAC/child-safety materials."
echo "     Do not deliver files unless the command exits 0."
echo "------------------------------------------------"
echo ""
