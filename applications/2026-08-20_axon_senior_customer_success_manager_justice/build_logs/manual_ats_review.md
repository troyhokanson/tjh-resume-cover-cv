...
Role: Sr Customer Success Manager - Justice, Axon (7871599003)
...
- Employment inside a prosecutor or public defender office
- Direct federal-prosecutor correspondence
- Ownership of an Enterprise SaaS customer portfolio
- Renewal, ARR, NRR, churn, or customer-health ownership
- Formal QBR ownership or CRM administration
- Commercial product-adoption dashboards
- Public-facing case identifiers or sensitive participant details

## Automatic extractor limitation

The repository's legacy ATS extractor does not offer a `customer-success` profile and treats job-metadata phrases and URL fragments as candidate keywords. Its vendor-solutions fallback report is retained as supplemental evidence only. The repository's customer-success validator, privacy scan, anti-AI scan, and this truth-safe manual review control the readiness decision.
