...
OpenAI's Abuse Investigator, Child Safety position closely matches the work I performed with the Minnesota Internet Crimes Against Children Task Force and the Dakota County Electronic Crimes Task Force. My background combines full-lifecycle child-exploitation investigations, digital forensics, time-sensitive on-call response, written findings, and direct coordination with law enforcement, prosecutors, federal partners, and NCMEC.

The records I reviewed for this application document 35 child-exploitation matters from 2017-2021. Twenty-seven involved CSAM production, possession, or dissemination, and 8 involved child solicitation or online exploitation. I served as the lead or assigned investigator in 19 matters and as the digital forensic examiner or investigative support in 16. Many of my lead CSAM cases began with an NCMEC CyberTipline referral routed through the Minnesota BCA and ICAC Task Force. I handled suspect attribution, preservation requests, search warrants, evidence seizure, forensic examination, submission of suspected CSAM to NCMEC for confirmation, and delivery of the completed case file to county or federal prosecutors.

That work required more than finding prohibited files. It required understanding the actor, the account, the device, the behavior, and the risk to a child. I used mobile and computer forensics, cloud-provider returns, location records, communications, OSINT, interviews, and timelines to connect those pieces. In one production case, immediate Google preservation and later analysis of synchronized cloud evidence recovered material the offender tried to delete. In another, mobile-device evidence supported a federal production conviction and a 15-year sentence. The point was always the same: identify the risk accurately, preserve what could disappear, communicate the findings clearly, and move the case to the people authorized to act.
