...
Never convert end-user experience into vendor-employment experience. Never convert brief exposure into expertise.
...
> Troy has used public-safety technology from the patrol car, interview room, crime scene, digital-forensics lab, classroom, and investigator's desk. He understands not only what the product is supposed to do, but what officers, investigators, analysts, supervisors, IT staff, prosecutors, and evidence personnel need it to do under real operational pressure.
...
| **P1 — Agency-side project involvement** | Participated as the customer/end-user organization in implementation or adoption | `agency-side project experience`, `worked with the vendor`, `supported rollout`, `helped integrate into workflow` |
| **A1 — Adjacent/current awareness** | Understands the use case or local adoption but did not personally operate it | `developing domain knowledge`, `agency-adoption awareness`, `operationally informed` |
...
| **Whelen lightbars and public-safety vehicle equipment** | D2 | Direct operational use of emergency warning and squad-equipment systems | Supports Whelen, fleet-equipment, field-training, customer-success, and public-safety product roles; spelling is `Whelen` |
...
For Axon applications, the strongest truthful narrative is:
...
- This should be treated as **P1 agency-side project involvement**, not merely general ALPR familiarity.
...
- Current-version expertise
- Procurement authority unless supported by project records

### Strategic impact

**Genetec should be treated as an upper-Tier-2/high-priority target**, particularly for:

- AutoVu / ALPR Solutions Consultant
- Public Safety Solutions Consultant
- Customer Success Manager
- Implementation or Professional Services Consultant
...
| **Exterro** | Direct AccessData FTK and FTK Imager experience under historical branding |
...
- Public-safety vehicle upfitters and fleet-technology companies
- Evidence-capture and interview-recording vendors
- Mission-critical communications companies
- Digital-evidence management companies
- Forensic hardware resellers and integrators
- Public-safety training and simulation vendors
...
### Lead with teaching and curriculum for

- Investigative Trainer
- Technical Trainer
- Customer Education Manager
- Customer Enablement Manager
- Academy or Curriculum Developer
- Train-the-Trainer Consultant
- Product Adoption and Onboarding roles
...
- `Motorola radio engineer`
- `Whelen fleet technician`
- `Current AutoVu expert`
- `Managed enterprise technology deployments` unless a specific documented project supports it
...
- Specific Motorola mobile and portable radio models
- Specific Whelen lightbar/control-system models
- Olympus recorder models and primary use cases
- Genetec AutoVu project records, dates, responsibilities, procurement material, training, and implementation documentation
- Exact dates of Axon Body 3 and Fleet 2 use

Absence of a model number does not erase valid end-user experience. It only limits model-specific claims.
